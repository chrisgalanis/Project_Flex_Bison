...
class_members:  variable_declaration SEMICOLON | variable_initialization SEMICOLON |   variable_assignment SEMICOLON | member_access SEMICOLON | class_instance SEMICOLON;
...
inside_brackets: %empty | loops_n_condition {function_counter++;} inside_brackets | function_call SEMICOLON inside_brackets | print SEMICOLON inside_brackets | class_members inside_brackets;
